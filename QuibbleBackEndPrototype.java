...
public class QuibbleBackEndPrototype {
   ...
   static  Scanner input= new Scanner(System.in);
    ...
    static List<String> mergedEventTransactionFile;
    static List<Event> alteredEventsFile;
 ...
 */
  public static void ProcessTransaction(){
	 ...
	 //makes each line of the masterEventFile into an Event object for easier processing
	  ...
	  String newMasterEventsFile = null;
	  String newCurrentEventsFile = null;
 ...
 */
  ...
  public static class Transaction{
	  ...
	  public Transaction(String transactionLine){
			String delims = "[ ]";
			String[] tokens = transactionLine.split(delims);
	  ...
	  public String getEventLine(){
		  return Integer.toString(date)+ " " +Integer.toString(ticket)+" "+name;
	  }
  }
